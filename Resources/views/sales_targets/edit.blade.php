@extends('layouts.app')
@section('title', __('user.edit_sales_target'))
@section('content')
    <section class="content-header">
        <h1 class="tw-text-xl md:tw-text-3xl tw-font-bold tw-text-black">Edit Sales Target</h1>
    </section>
    <section class="content">
        {!! Form::model($salesTarget, [
            'url' => action(
                [\Modules\CommissionAgent\Http\Controllers\SalesTargetController::class, 'update'],
                $salesTarget->id,
            ),
            'method' => 'put',
            'id' => 'sales_target_edit_form',
        ]) !!}
        @if ($errors->has('error'))
                ...
                @component('components.widget')
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('user_id', $users, $salesTarget->user_id, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('category_id', $categories, $salesTarget->category_id, [
                                'class' => 'form-control select2',
                                'id' => 'category_select',
                                'placeholder' => __('messages.please_select'),
                            ]) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('minimum_sales', $salesTarget->minimum_sales, [
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('maximum_sales', $salesTarget->maximum_sales, [
                                'class' => 'form-control text-right',
                            ]) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::select('commission_type', $targetType, $salesTarget->commission_type, [
                                'class' => 'form-control select2',
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::number('commission_value', $salesTarget->commission_value, [
                                'class' => 'form-control text-right',
                            ]) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::date('start_date', \Carbon\Carbon::parse($salesTarget->start_date)->format('Y-m-d'), [
                                'class' => 'form-control',
                            ]) !!}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::date('end_date', \Carbon\Carbon::parse($salesTarget->end_date)->format('Y-m-d'), [
                                'class' => 'form-control',
                            ]) !!}
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('form#sales_target_edit_form').validate({
                rules: {
                    user_id: {
                        required: true
                    },
            ...
            $('form#sales_target_edit_form input, form#sales_target_edit_form select').on('change', function() {
